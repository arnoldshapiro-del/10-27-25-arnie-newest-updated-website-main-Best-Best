// Social Anxiety Screening (SPIN based) Implementation
const questions = [
...
const options = ["Not at all", "A little bit", "Somewhat", "Very much", "Extremely"];
let currentScore = 0;
let currentLevel = "";
...
function calculateResults() {
  ...
  if (score < 21) {
    level = "Low social anxiety";
    color = "#10b981";
    recommendation = "Your responses suggest low social anxiety. Continue practicing social skills and self-care.";
  } else if (score < 31) {
    level = "Mild social anxiety";
    color = "#f59e0b";
    recommendation = "Your responses suggest mild social anxiety. Consider discussing coping strategies with a mental health professional.";
  } else if (score < 41) {
    level = "Moderate social anxiety";
    color = "#f97316";
    recommendation = "Your responses suggest moderate social anxiety. Recommend evaluation with a mental health professional.";
  } else if (score < 51) {
    level = "Severe social anxiety";
    color = "#ef4444";
    recommendation = "Your responses suggest severe social anxiety. Strongly recommend professional evaluation and treatment.";
  } else {
    level = "Very severe social anxiety";
    color = "#dc2626";
    recommendation = "Your responses suggest very severe social anxiety. Please seek professional help as soon as possible.";
  }
...
function downloadPDF() {
  ...
  const doc = new jsPDF();
  const title = "Social Anxiety Screening (SPIN) Results";
  ...
  doc.setFontSize(16);
  doc.setFont('helvetica', 'bold');
  doc.text('Total Score: ' + currentScore + '/68', 105, yPos + 12, { align: 'center' });
  doc.setFontSize(12);
  ...
  doc.save('Social_Anxiety_SPIN_Results_' + new Date().toISOString().split('T')[0] + '.pdf');
}
